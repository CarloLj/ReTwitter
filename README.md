...
**ReTwitter** is an android app that allows a user to view their Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='gifs/lastversion.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- Struggled with the UI, but at this time learned a lot about styling and UI design
- Pass the Tweets via Intent and return data
